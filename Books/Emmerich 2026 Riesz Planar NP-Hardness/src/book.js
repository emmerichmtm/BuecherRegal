...
var STORE_KEY = "emmerich-2026-riesz-planar-book-v1";
...
function typeset() {
  ...
  window.renderMathInElement(srcEl, {
    ...
    macros: {
      ...
      "\\abs": "\\lvert #1 \\rvert", "\\norm": "\\lVert #1 \\rVert",
      "\\RSSP": "\\textsc{Riesz-Subset}", "\\MIS": "\\textsc{Independent-Set}",
      "\\sgnspin": "\\{-1,+1\\}"
    }
  });
}
...
function wire() {
  ...
  $("#btnExport").addEventListener("click", function () {
    ...
    var name = "emmerich-2026-riesz-planar-annotations.json";
